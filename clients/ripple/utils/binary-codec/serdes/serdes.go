...
func (p *BinaryParser) ReadField() (*d.FieldInstance, error) {
	fh, err := p.readFieldHeader()
	if err != nil {
		return nil, err
	}
	fn, err := d.Get().GetFieldNameByFieldHeader(*fh)
	if err != nil {
		return nil, err
	}
	f, err := d.Get().GetFieldInstanceByFieldName(fn)
	if err != nil {
		return nil, err
	}
	if err != nil {
...
func (p *BinaryParser) readFieldHeader() (*d.FieldHeader, error) {
