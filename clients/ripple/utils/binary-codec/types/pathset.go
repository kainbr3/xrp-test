...
import (
	...
	addresscodec "crypto-braza-tokens-api/clients/ripple/utils/address-codec"
)
...
func (p PathSet) ToJson(parser *s.BinaryParser, opts ...int) (any, error) {
	var pathSet []any
...
func parsePathStep(parser *s.BinaryParser) (map[string]any, error) {
...
func parsePath(parser *s.BinaryParser) ([]any, error) {
	var path []any
